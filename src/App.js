  ...
  <Preloader className="preload" style={loading_style}>
    <Placeholder>
      <PreloaderWindow>
          ...
          >
            <g>
              <path
                id="XMLID_10_"
                className="st0"
                d="M211.2,126.2c0,50.8-32.4,91.9-91.9,91.9s-86.8-47.9-91.9-91.9s7.6-91.9,91.9-91.9
                C174.5,34.3,211.2,75.5,211.2,126.2z"
              />
              <path
                id="XMLID_9_"
                className="st1"
                d="M170.2,152.7c0,17.4-14.1,31.5-31.5,31.5s-28.3-12-31.5-31.5c-3.2-19.5,3.9-36.5,31.5-31.5
                S170.2,135.3,170.2,152.7z"
              />
              <path
                id="XMLID_8_"
                className="st2"
                d="M266.6,58.9c0,33.9-23.2,48.6-55,55c-31.8,6.5-54.6-37.4-55-55s0-39,55-55S266.6,25,266.6,58.9z
                "
              />
              <path
                id="XMLID_5_"
                className="st3"
                d="M52.9,218.2c0,14.6-10.1,23.1-26.4,26.4S0,232.8,0,218.2s4.5-23,26.4-26.4
                C48.3,188.3,52.9,203.6,52.9,218.2z"
              />
              <g>
                <path
                  className="st4"
                  d="M333.7,49.6h10.2l1,5.6h0.3c1.7-3.7,4.6-6.7,9.9-6.7c4,0,6.8,2.6,7.9,7.5c1.6-4.1,4.9-7.5,10.1-7.5
                ...
                <path
                  className="st4"
                  d="M391.4,82.6c0-10.2,8.5-15.4,30-16.8c-0.5-4.1-3.6-6.6-9.7-6.6c-4.4,0-8.8,1.7-13.9,4.3l-4.8-8.9
                ...
                <path
                  className="st4"
                  d="M451.6,49.6h11.1l1.1,10h0.3c4.5-7.5,11.2-11.1,18.5-11.1c4,0,6.1,0.7,8.8,1.8l-2.7,11.4
                  c-2.9-0.9-4.7-1.3-8.1-1.3c-5.7,0-11.5,2.9-15.4,11.1v23.8h-13.6V49.6z"
                />
                <path
                  className="st4"
                  d="M521.9,60.2h-18.4V49.6h31.9v45.7h-13.6V60.2z M519,34.2c0-5,3.8-8.4,9-8.4c5.2,0,9,3.5,9,8.4
                  c0,5-3.8,8.3-9,8.3C522.8,42.5,519,39.2,519,34.2z"
                />
                <path
                  className="st4"
                  d="M557.1,82.6c0-10.2,8.5-15.4,30-16.8c-0.5-4.1-3.6-6.6-9.7-6.6c-4.4,0-8.8,1.7-13.9,4.3l-4.8-8.9
                  c6.3-3.6,13.6-6.2,21.4-6.2c12.8,0,20.6,6.7,20.6,20.7v26.1h-11.1l-1-5.1h-0.3c-4.6,3.5-10.3,6.3-16.2,6.3
                ...
                <path
                  className="st4"
                  d="M335.3,213.5c0-3.7,2.4-6.8,7.1-9.1V204c-2.5-1.6-4.6-3.9-4.6-7.8c0-3.1,2.2-6.3,5.5-8.6v-0.4
                ...
                <path
                  className="st4"
                  d="M391.4,193.1c0-10.2,8.5-15.4,30-16.8c-0.5-4.1-3.6-6.6-9.7-6.6c-4.4,0-8.8,1.7-13.9,4.3l-4.8-8.9
                  c6.3-3.6,13.6-6.2,21.4-6.2c12.8,0,20.6,6.7,20.6,20.7v26.1h-11.1l-1-5.1h-0.3c-4.6,3.5-10.3,6.3-16.2,6.3
                ...
                <path
                  className="st4"
                  d="M459.9,187.9v-36h-14.4v-10.6h27.9v47.2c0,5.6,3.6,7.5,7.4,7.5c2.1,0,4.3-0.4,7.1-1.5l3,10
                  c-4.7,1.6-8,2.5-13.6,2.5C465.9,206.9,459.9,199.5,459.9,187.9z"
                />
                <path
                  className="st4"
                  d="M521.9,170.7h-18.4v-10.6h31.9v45.7h-13.6V170.7z M519,144.7c0-5,3.8-8.4,9-8.4c5.2,0,9,3.5,9,8.4
                  c0,5-3.8,8.3-9,8.3C522.8,152.9,519,149.6,519,144.7z"
                />
                <path
                  className="st4"
                  d="M558.4,141.3H572v37.2h0.4l16.8-18.4h14.8l-32,34.2v11.5h-13.6V141.3z M577.5,185.1l7.8-8.4l20.2,29.1h-14.7
                  L577.5,185.1z"
                />
                <path
                  className="st4"
                  d="M611.1,182.9c0-15.2,11.2-24,23.3-24s23.3,8.8,23.3,24c0,15.2-11.2,23.9-23.3,23.9S611.1,198.1,611.1,182.9z
                  M643.8,182.9c0-7.9-3.2-13-9.4-13c-6.2,0-9.4,5.1-9.4,13c0,7.9,3.2,13,9.4,13C640.6,195.9,643.8,190.8,643.8,182.9z"
                />
                <path
                  className="st4"
                  d="M664.9,160.1h13.6l7.2,21.5c1.5,4.6,2.7,9.3,4.1,14.1h0.4c1.4-4.8,2.6-9.5,4.1-14.1l7.2-21.5h12.9l-16.7,45.7
                  h-15.5L664.9,160.1z"
                />
                <path
                  className="st4"
                  d="M722.9,193.1c0-10.2,8.5-15.4,30-16.8c-0.5-4.1-3.6-6.6-9.7-6.6c-4.4,0-8.8,1.7-13.9,4.3l-4.8-8.9
                  c6.3-3.6,13.6-6.2,21.4-6.2c12.8,0,20.6,6.7,20.6,20.7v26.1h-11.1l-1-5.1h-0.3c-4.6,3.5-10.3,6.3-16.2,6.3
        ...
        <div className="loader_wrapper">stránka sa načítava</div>
    ...
    <Router>
      <AppStyles>
        <Head>
          ...
          <meta
            name="keywords"
            content="maria galikova,zivotny kouc,zivotny poradca,zivotna zmena,poradca pre zeny"
          />
          <link rel="shortcut icon" type="image/png" href="/favicon.png" />
          <link
            href="https://fonts.googleapis.com/css?family=Pacifico|Poppins:300,400,700,900&amp;subset=latin-ext"
            rel="stylesheet"
          />
        </Head>
        <Logo />
